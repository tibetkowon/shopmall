        ...
        -------------------------->
        		<div class="row">
					...
					<div class="col-md-12">
						...
						<form role="insertForm" action="/order/quickInsert" method="post">
							...
							<div class="box-body">
								<table class="table table-bordered text-center" id="cartList">
									...
									<tr>
										...
										<td class="col-md-4 text-left"><b>${product.product_name}</b>
										</td>
										<td class="col-md-2">
										<fmt:formatNumber value="${product.product_price*product.product_count}" pattern="#,###.##"/> 원
											<input type="hidden" name="order_price" value="${product.product_price*product.product_count}">
										</td>
										<td class="col-md-1">${product.product_count}
											<input type="hidden" name="order_count" value="${product.product_count}">
								...
								<div class="box-footer">
									<p class="text-right" style="padding-right: 20px;">
										총 주문 금액 &nbsp;&nbsp;:&nbsp;&nbsp;<span
											style="font-size: 20px;"><b><fmt:formatNumber value="${product.product_price*product.product_count}" pattern="#,###.##"/> 원</b></span>
									</p>
								</div>
							</div>
						</div>
						<div class="box box-danger">
							<div class="box-header">
								...
								<input type="hidden" name="order_sumprice" value="${product.product_price*product.product_count}"> <!-- 총 주문 금액 -->
