...
<script>
	...
	$(function() {
		...
		$("#btn-emailChange").one("click",function(){
			email_check = false;
			$("#user_email").attr('readonly',false);
			$("#btn-emailChange").attr('class','btn btn-primary');
			$("#btn-emailChange").attr('value','이메일 인증');
			$("#btn-emailChange").attr('id','btn-email');
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="container" style="width: 100%">
							...
							<form action="/user/modify" method="post" role="modify"
								class="center-block">
									...
									<div class="row" id="div_id">
										<div class="col-xs-5">
											<input type="text" name="user_id" id="user_id"
												class="form-control" readonly="readonly" value="${userVO.user_id }">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="row">
										<div class="col-xs-5">
											<input type="text" name="user_name" id="user_name"
												class="form-control" value="${userVO.user_name}">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="row">
										<div class="col-xs-5">
											<input type="text" name="user_email" id="user_email"
												class="form-control" value="${userVO.user_email }" readonly>
										</div>
										<input type="button" id="btn-emailChange"
											value="이메일 변경" class="btn btn-success">
									</div>
								</div>
									...
									<div class="row">
										<div class="col-xs-3">
											<input type="text" name="user_postcode" id="postcode"
												placeholder="우편번호" class="form-control" readonly="readonly" value="${userVO.user_postcode }">
										</div>
										...
										<div class="row">
											<div class="col-xs-10">
												<input type="text" name="user_address" id="addr"
													class="form-control" placeholder="주소" readonly="readonly" value="${userVO.user_address }">
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xs-5">
											<input type="text" name="user_detailaddr" id="detailaddr"
												class="form-control" value="${userVO.user_detailaddr }">
										</div>
										<div class="col-xs-5">
									...
									<div class="row">
										<div class="col-xs-5">
											<input type="text" name="user_phonenum" class="form-control"
												id="user_phonenum" value="${userVO.user_phonenum }">
										</div>
									</div>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">이메일 수신 여부</label><br />
									 <input type="radio" name="user_mail_check" value="N" 
									 <c:if test="${userVO.user_mail_check.toString() eq 'N'}">checked</c:if>> NO
										 <input type="radio" name="user_mail_check" value="Y"
										 <c:if test="${userVO.user_mail_check.toString() eq 'Y'}">checked</c:if>> YES
								</div>
